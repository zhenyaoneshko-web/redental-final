(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".team__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            new swiper_core_Swiper(".coment__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            new swiper_core_Swiper(".secondblock-implantation__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            new swiper_core_Swiper(".fivesblock-implantation__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        [].forEach.call(document.querySelectorAll(".tel"), (function(input) {
            ...
            function mask(event) {
                ...
                var matrix = "38 (___) ___ ____", i = 0, def = matrix.replace(/\D/g, ""), val = this.value.replace(/\D/g, ""), new_value = matrix.replace(/[_\d]/g, (function(a) {
    ...
    function getUTMParameters() {
        ...
        document.getElementById("utm_source__2").value = utmSource;
        document.getElementById("utm_medium__2").value = utmMedium;
        document.getElementById("utm_campaign__2").value = utmCampaign;
        document.getElementById("utm_content__2").value = utmContent;
        document.getElementById("utm_term__2").value = utmTerm;
    }
    getUTMParameters();
    window["FLS"] = true;
    isWebp();
